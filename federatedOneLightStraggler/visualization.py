...
def create_time_comparison_plot(data):
    ...
    ax.set_title('Time Efficiency Comparison in a Light Straggler Environment', fontsize=18, pad=20)
...
def create_work_comparison_plot(data):
    ...
    ax.set_ylabel('Global Model Accuracy (%)', fontsize=14)
    ax.set_title('Work Efficiency Comparison in a Light Straggler Environment', fontsize=18, pad=20)
    ax.legend(fontsize=12, loc='lower right')
    ax.tick_params(axis='both', which='major', labelsize=12)
    ax.set_ylim(bottom=0) 
...
def create_time_ablation_plot(data):
    ...
    ax.set_xlabel('Wall-Clock Time (seconds)', fontsize=14)
    ax.set_ylabel('Global Model Accuracy (%)', fontsize=14)
    ax.set_title('Time Efficiency of Asynchronous Staleness Mitigation Techniques in a Light Straggler Environment', fontsize=18, pad=20)
    ax.legend(fontsize=12, loc='lower right')
    ax.tick_params(axis='both', which='major', labelsize=12)
    ax.set_ylim(bottom=0) 
    ax.set_xlim(left=0)
...
def create_work_ablation_plot(data):
    ...
    ax.set_xlabel('Total Client Trainings Completed', fontsize=14)
    ax.set_ylabel('Global Model Accuracy (%)', fontsize=14)
    ax.set_title('Work Efficiency of Staleness Mitigation Techniques in a Light Straggler Environment', fontsize=18, pad=20)
    ax.legend(fontsize=12, loc='lower right')
    ax.tick_params(axis='both', which='major', labelsize=12)
    ax.set_ylim(bottom=0) 
    ax.set_xlim(left=0, right=110)
