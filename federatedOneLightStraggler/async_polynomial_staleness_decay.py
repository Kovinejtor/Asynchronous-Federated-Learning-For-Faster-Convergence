...
def calculate_dynamic_alpha(staleness: int) -> float:
    ...
    decay_factor = staleness / STALENESS_THRESHOLD
    factor = (1.0 - decay_factor) ** STALENESS_EXPONENT
...
async def main():
    print("Starting asynchronous FL with polynomial staleness decay simulation...")
    ...
    print("\n Asynchronous FL with polynomial staleness decay simulation finished")
    
    with open("async_polynomial_staleness_decay_results.json", "w") as f:
        json.dump(results_log, f, indent=2)
    print("Staleness-aware results saved to 'async_polynomial_staleness_decay_results.json'")
