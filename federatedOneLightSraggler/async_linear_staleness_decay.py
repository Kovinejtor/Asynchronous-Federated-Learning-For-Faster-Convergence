...
def calculate_dynamic_alpha(staleness: int) -> float:
    factor = 1.0 - (staleness / STALENESS_THRESHOLD)
...
async def main():
    print("Starting asynchronous FL with linear staleness decay simulation...")
    ...
    print("\n Asynchronous FL with linear staleness decay simulation finished")
    
    with open("async_linear_staleness_decay_results.json", "w") as f:
        json.dump(results_log, f, indent=2)
    print("Staleness-aware results saved to 'async_linear_staleness_decay_results.json'")
