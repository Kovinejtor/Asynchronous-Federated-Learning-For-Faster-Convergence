...
def calculate_dynamic_alpha(staleness: int) -> float:
    return BASE_ALPHA * math.exp(-staleness * DECAY_RATE)
...
async def main():
    print("Starting asynchronous FL with exponential staleness decay simulation...")
    ...
    print("\n Asynchronous FL with exponential staleness decay simulation finished")
    
    with open("async_exponential_staleness_decay_results.json", "w") as f:
        json.dump(results_log, f, indent=2)
    print("Staleness-aware results saved to 'async_exponential_staleness_decay_results.json'")
